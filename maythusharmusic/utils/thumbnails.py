    ...
    try:
        ...
        if 1==1:
            ...
            async with aiohttp.ClientSession() as session:
                async with session.get(f"http://img.youtube.com/vi/{videoid}/maxresdefault.png") as resp:
                    if resp.status == 200:
            ...
            circle = Image.open("maythusharmusic/assets/circle.png")
            ...
            # fonts
            font1 = ImageFont.truetype('maythusharmusic/assets/font.ttf', 30)
            font2 = ImageFont.truetype('maythusharmusic/assets/font2.ttf', 70)
            font3 = ImageFont.truetype('maythusharmusic/assets/font2.ttf', 40)
            font4 = ImageFont.truetype('maythusharmusic/assets/font2.ttf', 35)

            image4 = ImageDraw.Draw(image2)
            image4.text((10, 10), "UCHIHA[SASUKE] x MUSIC", fill="white", font = font1, align ="left") 
