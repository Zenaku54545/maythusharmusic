    ...
    async def speedup_stream(self, chat_id: int, file_path, speed, playing):
        ...
        stream = (
            AudioVideoPiped(
                ...
                video_parameters=VideoQuality.SD_720p,
    ...
    async def join_call(
        ...
        if video:
            ...
            stream = (
                ...
                if video
                else AudioPiped(link, audio_parameters=AudioQuality.STUDIO)
            )
        try:
            await assistant.join_group_call(
                chat_id,
        ...
        try:
            ...
            if "live_" in queued:
                ...
                stream = (
                    ...
                    else AudioPiped(videoid, audio_parameters=AudioQuality.STUDIO)
                )
                try:
                    await client.change_stream(chat_id, stream)
                except:
